...
('/uploads/class1_photo3.jpg', 1, 1, 1, '{"child_ids": [4, 5, 6], "confidence": 0.88}'),
('/uploads/class1_photo4.jpg', 1, 1, 0, '{"child_ids": [1], "confidence": 0.97}'),
('/uploads/class1_photo5.jpg', 1, 1, 1, '{"child_ids": [7, 8], "confidence": 0.91}'),
('/uploads/class1_photo6.jpg', 1, 1, 1, '{"child_ids": [9, 10], "confidence": 0.94}'),
('/uploads/class1_photo7.jpg', 1, 1, 1, '{"child_ids": [2, 3, 4], "confidence": 0.89}'),
('/uploads/class1_photo8.jpg', 1, 1, 0, '{"child_ids": [5], "confidence": 0.96}'),
('/uploads/class1_photo9.jpg', 1, 1, 1, '{"child_ids": [6, 7], "confidence": 0.93}'),
('/uploads/class1_photo10.jpg', 1, 1, 1, '{"child_ids": [8], "confidence": 0.90}'),
('/uploads/class1_photo11.jpg', 1, 1, 1, '{"child_ids": [9], "confidence": 0.92}'),
('/uploads/class1_photo12.jpg', 1, 1, 0, '{"child_ids": [10, 1], "confidence": 0.87}'),
('/uploads/class1_photo13.jpg', 1, 1, 1, '{"child_ids": [2], "confidence": 0.95}'),
('/uploads/class1_photo14.jpg', 1, 1, 1, '{"child_ids": [3, 4], "confidence": 0.91}'),
('/uploads/class1_photo15.jpg', 1, 1, 1, '{"child_ids": [5, 6, 7], "confidence": 0.86}'),

-- 小二班照片
('/uploads/class2_photo1.jpg', 2, 2, 1, '{"child_ids": [11, 12], "confidence": 0.94}'),
('/uploads/class2_photo2.jpg', 2, 2, 1, '{"child_ids": [13], "confidence": 0.93}'),
('/uploads/class2_photo3.jpg', 2, 2, 1, '{"child_ids": [14, 15], "confidence": 0.89}'),
('/uploads/class2_photo4.jpg', 2, 2, 0, '{"child_ids": [16], "confidence": 0.96}'),
('/uploads/class2_photo5.jpg', 2, 2, 1, '{"child_ids": [17, 18], "confidence": 0.92}'),
('/uploads/class2_photo6.jpg', 2, 2, 1, '{"child_ids": [19, 20], "confidence": 0.90}'),
('/uploads/class2_photo7.jpg', 2, 2, 1, '{"child_ids": [11, 13], "confidence": 0.88}'),
('/uploads/class2_photo8.jpg', 2, 2, 0, '{"child_ids": [14], "confidence": 0.95}'),
('/uploads/class2_photo9.jpg', 2, 2, 1, '{"child_ids": [15, 16], "confidence": 0.91}'),
('/uploads/class2_photo10.jpg', 2, 2, 1, '{"child_ids": [17], "confidence": 0.93}'),
('/uploads/class2_photo11.jpg', 2, 2, 1, '{"child_ids": [18, 19], "confidence": 0.87}'),
('/uploads/class2_photo12.jpg', 2, 2, 0, '{"child_ids": [20], "confidence": 0.94}'),
('/uploads/class2_photo13.jpg', 2, 2, 1, '{"child_ids": [11, 12, 13], "confidence": 0.85}'),
('/uploads/class2_photo14.jpg', 2, 2, 1, '{"child_ids": [14, 15], "confidence": 0.92}'),
('/uploads/class2_photo15.jpg', 2, 2, 1, '{"child_ids": [16, 17], "confidence": 0.90}');
